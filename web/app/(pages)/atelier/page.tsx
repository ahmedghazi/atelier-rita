...
import { ATELIER_QUERY, getAtelier } from "@/app/sanity-api/sanity-queries";
import { getClient } from "@/app/sanity-api/sanity.client";
import { ATELIER_QUERY_RESULT } from "@/app/types/sanity.types";
...
const InfosPage = async function Page({ params }: PageProps) {
  ...
  if (isEnabled) {
    ...
    data = await getAtelier();
  }

  if (!data) return notFound();
  return (
    <div className='template template--atelier' data-template='atelier'>
      <ContentAtelier input={data} />
